...
@section('content')
    <div class="col-xl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('sumur-pantau.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12 mb-2">
                            <div>
                                ...
                                <div class="d-flex align-items-start align-items-sm-center gap-4">
                                    <img src="https://via.placeholder.com/600" alt="user-avatar" class="d-block rounded"
                                        width="100px" id="uploadedAvatar">
                        ...
                        <div class="d-flex flex-column gap-2 col-lg-6 mb-3">
                            <div>
                                ...
                                <input type="text" min="0"
                                  ...
                                  is-invalid
                                @enderror"
                                    value="{{ old('kode_sumur_pantau') }}" id="kode_sumur_pantau" name="kode_sumur_pantau"
                            ...
                            <div>
                                ...
                                <input type="number" min="0" inputmode="numeric"
                                  ...
                                  is-invalid
                                @enderror"
                                    value="{{ old('no_inventarisasi') }}" id="no_inventarisasi" name="no_inventarisasi"
                            ...
                            <div>
                                ...
                                <input type="text"
                                  ...
                                  is-invalid
                                @enderror"
                                    value="{{ old('lokasi') }}" id="lokasi" name="lokasi" placeholder="Masukan lokasi">
                                @error('lokasi')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
